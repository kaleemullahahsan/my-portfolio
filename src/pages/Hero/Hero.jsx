...
export default function Hero() {
  const words = [
    ...
    "Frontend Developer at Coding Force",
    "BSCS Student at VU | Passionate Learner",
    "Loves UI/UX & Digital Strategy",
  ];

  const [code] = useState(`
const profile = {
    name: 'Kaleemullah Ahsan',
    title: 'Front-End Developer | WP Expert | BSCS Student',
    skills: [
        'HTML', 'CSS', 'JavaScript', 'React',
        'WordPress', 'ThemeDev', 'PluginDev', 
        'TailwindCSS', 'Bootstrap', 'Git', 'Figma'
    ],
    hardWorker: true,
    quickLearner: true,
    problemSolver: true,
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  WordPress enthusiast 💡 | Frontend developer 🧠 | Blending
                  design and code to create impactful experiences 🎯
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="/Kaleemullah-Ahsan-Resume.pdf"
